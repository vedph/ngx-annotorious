...
import { MyImgAnnotationListComponent } from './components/img-annotation-list/my-img-annotation-list.component';
import { EditAnnotationDialogComponent } from './components/edit-annotation-dialog/edit-annotation-dialog.component';
